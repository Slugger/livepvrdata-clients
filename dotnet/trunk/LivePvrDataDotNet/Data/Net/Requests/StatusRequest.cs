...
namespace LivePvrData.Data.Net.Requests
{
    ...
    public class StatusRequest : Request
    {
        ...
        /// <param name="start">The UTC start time of the event; successive calls to query the same event should be using the same start time; do NOT pass the current time!</param>
